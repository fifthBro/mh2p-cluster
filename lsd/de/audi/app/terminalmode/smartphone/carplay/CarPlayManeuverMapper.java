...
/**
 * Maps CarPlay (iAP2) ManeuverType to BAP mainElement + direction.
 * Adapted from luka-dev/mib2q-carplay-rgi ManeuverMapper.java.
 * Original: MHI3 tbt_renderer parity, verified against dio_manager type-info.
 */
public class CarPlayManeuverMapper {
